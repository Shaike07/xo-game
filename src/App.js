    ...
    return (
      <div>
        <div className='points'>
          Your points earned: {this.state.points}
        </div>
        {
          this.state.error &&
          <div className='gameOver'>
            Game Over :(
            <button className='btn btn-warning ms-5' onClick={this.newGame}>
              NewGame
            </button>
          </div>
        }
        {
          ...
          <div className='gameOver'>
            You Win :)
            <button className='btn btn-success ms-5' onClick={this.nextlevel}>
              NextLevel
            </button>
          </div>
        }
